...
# this is for FDGk1 to k3 model training where k3 is log transformed, ignore zero k3 in training loss
# for ((i=1;i<=5;i++))
# do 
#     python train_test_cross_validation_FDGk1_k3_ignore_k3_00025_log.py \
...
#     --model pix2pix_32_fdg_k1_k3_ignore_test_k3_log \
#     --dataset_mode fdgk1_fmiso \
#     --checkpoints_dir /lila/home/zhaow2/pytorch-CycleGAN-and-pix2pix-master/checkpoints/fdgk1_k3_pix2pix_k3_log_transformed_ignore_00025_k3_fold"$i"_l1_l2_tumor_SE_16 \
#     --batch_size 1
# done

# this is for FDGk1 to k3 model training where k3 is NOT log transformed, ignore zero k3 in training loss
for ((i=2;i<=5;i++))
do 
    python train_test_cross_validation_FDGk1_k3_ignore_k3_00025_no_log.py \
