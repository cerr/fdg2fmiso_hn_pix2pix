...
#     --checkpoints_dir /lila/home/zhaow2/pytorch-CycleGAN-and-pix2pix-master/checkpoints/fdg_TBR_pix2pix_fold"$i"_l1_l2_tumor_pixel_D_three_down_layer_add_block_num \
#     --batch_size 1
# done

for i in 3 4
do 
    python gradcam_FDGk1_tbr.py \
    --dataroot /lila/data/deasy/data_harini/wei_head_neck_FDG_FMISO/FDGk1_TBR_patch_pair_5Fold/"$i" \
    --name fdgk1_tbr_pix2pix \
    ...
    --no_augmentation \
    --gpu_ids -1 \
    --checkpoints_dir /lila/home/zhaow2/pytorch-CycleGAN-and-pix2pix-master/checkpoints/fdgk1_TBR_pix2pix_fold"$i"_l1_l2_tumor_pixel_D_three_down_layer_add_block_num 
done


# for i in 3 4
# do 
#     python gradcam_FDG_tbr.py \
#     --dataroot /lila/data/deasy/data_harini/wei_head_neck_FDG_FMISO/FDGk1_TBR_patch_pair_5Fold/"$i" \
#     --name fdg_tbr_pix2pix \
#     --model pix2pix_32_fdg_tbr_three_down_layer_add_block_number_pixel_d \
#     --dataset_mode fdg_tbr \
