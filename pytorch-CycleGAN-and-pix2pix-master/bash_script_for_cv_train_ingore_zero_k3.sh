...
# this is for FDGk1 to k3 model training where k3 is log transformed, ignore zero k3
for ((i=1;i<=5;i++))
do 
    ...
    --checkpoints_dir /lila/home/zhaow2/pytorch-CycleGAN-and-pix2pix-master/checkpoints/fdgk1_k3_pix2pix_k3_log_transformed_ignore_zero_k3_fold"$i"_l1_l2_tumor_SE_16 \
    --batch_size 1
done
