...
class Pix2Pix32FdgK1K3IgnoreTestK3LogModel(BaseModel):
    ...
    def backward_G(self):
        ...
        mask = torch.logical_and(torch.unsqueeze(self.real_A[:,1,:,:]>-1, 1), self.real_B>0.5844187)
