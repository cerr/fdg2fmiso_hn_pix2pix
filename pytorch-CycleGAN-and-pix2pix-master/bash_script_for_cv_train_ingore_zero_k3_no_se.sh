...
do 
    ...
    --name fdgk1_k3_pix2pix \
    --model pix2pix_32_fdg_k1_k3_ignore_zero_k3_no_se \
    --dataset_mode fdgk1_fmiso \
    --checkpoints_dir /lila/data/deasy/data_harini/wei_head_neck_FDG_FMISO/checkpoints/fdgk1_k3_pix2pix_ignore_zero_k3_fold"$i"_l1_l2_tumor_16 \
    --batch_size 1
done
