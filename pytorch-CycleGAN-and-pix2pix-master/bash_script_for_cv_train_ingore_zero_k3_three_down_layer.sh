...
# for ((i=1;i<=5;i++))
# do 
#     python train_test_cross_validation_FDGk1_k3_ingore_zero_k3.py \
...
do 
    ...
    --name fdgk1_k3_pix2pix \
    --model pix2pix_32_ignore_zero_k3_three_down_layer \
    --dataset_mode fdgk1_fmiso \
    --checkpoints_dir /lila/home/zhaow2/pytorch-CycleGAN-and-pix2pix-master/checkpoints/fdgk1_k3_pix2pix_ignore_zero_k3_fold"$i"_l1_l2_tumor_SE_16_three_down_layer \
    --batch_size 1
done
