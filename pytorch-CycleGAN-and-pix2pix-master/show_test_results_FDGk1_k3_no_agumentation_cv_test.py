...
if __name__ == '__main__':
    ...
    opt.results_dir = os.path.join(opt.checkpoints_dir, 'best_model_test_result_image_no_augmentation_cv_test')
    if not os.path.isdir(opt.results_dir):
        os.mkdir(opt.results_dir)
    if not os.path.isdir(os.path.join(opt.checkpoints_dir, 'best_model_test_result_mat_no_augmentation_cv_test')):
        os.mkdir(os.path.join(opt.checkpoints_dir, 'best_model_test_result_mat_no_augmentation_cv_test'))
    ...
    mae_file_name = os.path.join(opt.checkpoints_dir, 'best_model_mae_log_no_aug_cv_test.txt')
    ...
    for i, data in enumerate(dataset):
        ...
        savemat(opt.checkpoints_dir + '/best_model_test_result_mat_no_augmentation_cv_test/' + name + '.mat', data_dict)
