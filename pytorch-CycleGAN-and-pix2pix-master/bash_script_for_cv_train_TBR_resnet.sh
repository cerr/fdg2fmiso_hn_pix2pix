...
#     --model pix2pix_32_tbr_resnet3b_pixel_d \
#     --dataset_mode fdgk1_fmiso \
#     --checkpoints_dir /lila/home/zhaow2/pytorch-CycleGAN-and-pix2pix-master/checkpoints/fdgk1_TBR_pix2pix_fold"$i"_l1_l2_tumor_pixel_D_resnet3b \
#     --batch_size 1
# done
