...
#     --checkpoints_dir /lila/home/zhaow2/pytorch-CycleGAN-and-pix2pix-master/checkpoints/fdgk1_TBR_pix2pix_fold"$i"_l1_l2_tumor_16_wgan_three_down_layer \
#     --batch_size 1
# done
...
for ((i=1;i<=5;i++))
do
    python train_test_cross_validation_FDG_tbr.py \
    --dataroot /lila/data/deasy/data_harini/wei_head_neck_FDG_FMISO/FDGk1_TBR_patch_pair_5Fold/"$i" \
    --name fdg_tbr_pix2pix \
    --model pix2pix_32_fdg_tbr_three_down_layer_pixel_d \
    --dataset_mode fdg_tbr \
    --checkpoints_dir /lila/home/zhaow2/pytorch-CycleGAN-and-pix2pix-master/checkpoints/fdg_TBR_pix2pix_fold"$i"_l1_l2_tumor_pixel_D_three_down_layer \
    --batch_size 1
done

for ((i=1;i<=5;i++))
do 
    python show_test_results_FDG_tbr.py \
    --dataroot /lila/data/deasy/data_harini/wei_head_neck_FDG_FMISO/FDGk1_TBR_patch_pair_5Fold/"$i" \
    --name fdg_tbr_pix2pix \
    --model pix2pix_32_fdg_tbr_three_down_layer_pixel_d \
    --dataset_mode fdg_tbr \
...
do
    ...
    --dataroot /lila/data/deasy/data_harini/wei_head_neck_FDG_FMISO/FDGk1_TBR_patch_pair_5Fold/"$i" \
    --name fdg_tbr_pix2pix \
    --model pix2pix_32_fdg_tbr_wgan_three_down_layer \
    --dataset_mode fdg_tbr \
    --checkpoints_dir /lila/home/zhaow2/pytorch-CycleGAN-and-pix2pix-master/checkpoints/fdg_TBR_pix2pix_fold"$i"_l1_l2_tumor_16_wgan_three_down_layer \
    --batch_size 1
done
...
do
    ...
    --dataroot /lila/data/deasy/data_harini/wei_head_neck_FDG_FMISO/FDGk1_TBR_patch_pair_5Fold/"$i" \
    --name fdg_tbr_pix2pix \
    --model pix2pix_32_fdg_tbr \
    --dataset_mode fdg_tbr \
    --checkpoints_dir /lila/home/zhaow2/pytorch-CycleGAN-and-pix2pix-master/checkpoints/fdg_TBR_pix2pix_fold"$i"_l1_l2_tumor_16 \
    --batch_size 1
done
...
do
    ...
    --dataroot /lila/data/deasy/data_harini/wei_head_neck_FDG_FMISO/FDGk1_TBR_patch_pair_5Fold/"$i" \
    --name fdg_tbr_pix2pix \
    --model pix2pix_32_fdg_tbr_wgan \
    --dataset_mode fdg_tbr \
    --checkpoints_dir /lila/home/zhaow2/pytorch-CycleGAN-and-pix2pix-master/checkpoints/fdg_TBR_pix2pix_fold"$i"_l1_l2_tumor_16_wgan \
    --batch_size 1
done
...
do
    ...
    --dataroot /lila/data/deasy/data_harini/wei_head_neck_FDG_FMISO/FDGk1_TBR_patch_pair_5Fold/"$i" \
    --name fdg_tbr_pix2pix \
    --model pix2pix_32_fdg_tbr_se_all_layer \
    --dataset_mode fdg_tbr \
    --checkpoints_dir /lila/home/zhaow2/pytorch-CycleGAN-and-pix2pix-master/checkpoints/fdg_TBR_pix2pix_fold"$i"_l1_l2_tumor_16_se_all_layer \
    --batch_size 1
done
...
#     --dataroot /lila/data/deasy/data_harini/wei_head_neck_FDG_FMISO/FDGk1_TBR_patch_pair_5Fold/"$i" \
#     --name fdgk1_tbr_pix2pix \
#     --model pix2pix_32_tbr_wgan_three_down_layer_large_lambda \
#     --dataset_mode fdgk1_fmiso \
