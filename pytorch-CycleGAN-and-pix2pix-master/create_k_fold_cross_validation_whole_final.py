...
#combined
whole_dir = '/lila/data/deasy/data_harini/wei_head_neck_FDG_FMISO/FDGk1_TBR_patch_pair_whole_final'
...
log_file_name = os.path.join('/lila/data/deasy/data_harini/wei_head_neck_FDG_FMISO', 'fold_separation_info_whole_final.txt')
